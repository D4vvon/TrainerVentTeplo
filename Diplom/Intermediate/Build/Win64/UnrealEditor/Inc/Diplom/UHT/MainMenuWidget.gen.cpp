...
#include "Diplom/UI/MainMenuWidget.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMainMenuWidget() {}
// Cross Module References
	DIPLOM_API UClass* Z_Construct_UClass_UMainMenuWidget();
	DIPLOM_API UClass* Z_Construct_UClass_UMainMenuWidget_NoRegister();
...
// End Cross Module References
	...
	template<> DIPLOM_API UClass* StaticClass<UMainMenuWidget>()
	{
		return UMainMenuWidget::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UMainMenuWidget);
	UMainMenuWidget::~UMainMenuWidget() {}
	struct Z_CompiledInDeferFile_FID_Ychebka_TrainerVentTeplo_Diplom_Source_Diplom_UI_MainMenuWidget_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Ychebka_TrainerVentTeplo_Diplom_Source_Diplom_UI_MainMenuWidget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMainMenuWidget, UMainMenuWidget::StaticClass, TEXT("UMainMenuWidget"), &Z_Registration_Info_UClass_UMainMenuWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMainMenuWidget), 1729635588U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Ychebka_TrainerVentTeplo_Diplom_Source_Diplom_UI_MainMenuWidget_h_1067185708(TEXT("/Script/Diplom"),
		Z_CompiledInDeferFile_FID_Ychebka_TrainerVentTeplo_Diplom_Source_Diplom_UI_MainMenuWidget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Ychebka_TrainerVentTeplo_Diplom_Source_Diplom_UI_MainMenuWidget_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
