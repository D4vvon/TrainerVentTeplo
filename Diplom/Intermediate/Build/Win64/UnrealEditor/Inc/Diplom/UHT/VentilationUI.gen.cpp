...
// End Cross Module References
	DEFINE_FUNCTION(UVentilationUI::execCreateRequest)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->CreateRequest();
		P_NATIVE_END;
	}
	...
	void UVentilationUI::StaticRegisterNativesUVentilationUI()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "CreateRequest", &UVentilationUI::execCreateRequest },
			{ "startRotateFan", &UVentilationUI::execstartRotateFan },
			{ "stopRotateFan", &UVentilationUI::execstopRotateFan },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_UVentilationUI_CreateRequest_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UVentilationUI_CreateRequest_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "UI/VentilationUI.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVentilationUI_CreateRequest_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVentilationUI, nullptr, "CreateRequest", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UVentilationUI_CreateRequest_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UVentilationUI_CreateRequest_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UVentilationUI_CreateRequest()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UVentilationUI_CreateRequest_Statics::FuncParams);
		}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UVentilationUI_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UVentilationUI_CreateRequest, "CreateRequest" }, // 4143825834
	...
	struct Z_CompiledInDeferFile_FID_Diplom_Diplom_Source_Diplom_UI_VentilationUI_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Diplom_Diplom_Source_Diplom_UI_VentilationUI_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVentilationUI, UVentilationUI::StaticClass, TEXT("UVentilationUI"), &Z_Registration_Info_UClass_UVentilationUI, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVentilationUI), 1926000556U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Diplom_Diplom_Source_Diplom_UI_VentilationUI_h_785732617(TEXT("/Script/Diplom"),
		Z_CompiledInDeferFile_FID_Diplom_Diplom_Source_Diplom_UI_VentilationUI_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Diplom_Diplom_Source_Diplom_UI_VentilationUI_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
