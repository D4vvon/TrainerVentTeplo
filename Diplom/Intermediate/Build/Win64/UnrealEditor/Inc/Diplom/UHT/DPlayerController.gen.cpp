...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_ADPlayerController_Statics::NewProp_PlayerHUDWidgetClass = { "PlayerHUDWidgetClass", nullptr, (EPropertyFlags)0x0024080000010015, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ADPlayerController, PlayerHUDWidgetClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UPlayerHUDWidget_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ADPlayerController_Statics::NewProp_PlayerHUDWidgetClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ADPlayerController_Statics::NewProp_PlayerHUDWidgetClass_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_ADPlayerController_Statics::NewProp_CopmonentOfMechanismClass = { "CopmonentOfMechanismClass", nullptr, (EPropertyFlags)0x0024080000010015, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ADPlayerController, CopmonentOfMechanismClass), Z_Construct_UClass_UClass, Z_Construct_UClass_AComponentOfMechanism_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ADPlayerController_Statics::NewProp_CopmonentOfMechanismClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ADPlayerController_Statics::NewProp_CopmonentOfMechanismClass_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_Ychebka_TrainerVentTeplo_Diplom_Source_Diplom_Characters_Controllers_DPlayerController_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Ychebka_TrainerVentTeplo_Diplom_Source_Diplom_Characters_Controllers_DPlayerController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ADPlayerController, ADPlayerController::StaticClass, TEXT("ADPlayerController"), &Z_Registration_Info_UClass_ADPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ADPlayerController), 2502753334U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Ychebka_TrainerVentTeplo_Diplom_Source_Diplom_Characters_Controllers_DPlayerController_h_2333477570(TEXT("/Script/Diplom"),
		Z_CompiledInDeferFile_FID_Ychebka_TrainerVentTeplo_Diplom_Source_Diplom_Characters_Controllers_DPlayerController_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Ychebka_TrainerVentTeplo_Diplom_Source_Diplom_Characters_Controllers_DPlayerController_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
